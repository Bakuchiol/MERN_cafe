...
//           const newFormData = {...formData}; //copy of form data to send new form data to the back
...
//           const user = await signUp(newFormData) //pass newformdata to signup function (inside userservice)
//           console.log(user);
//         } catch (err) {
//           // an error occured
